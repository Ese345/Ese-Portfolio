          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">
                I'm a passionate Frontend engnineer with over 2 years of experience 
                I love the intersection of design and technology, where beautiful 
              ...
              <div className="flex flex-wrap gap-3 mt-8">
                {["JavaScript", "TypeScript", "React", "Node.js", "Python", "PostgreSQL", "Excel","Poower BI","Zoho"].map((tech) => (
                  <span 
                    key={tech} 
